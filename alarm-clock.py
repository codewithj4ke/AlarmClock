...
# Create a Frame for the title (removed title label)
...
info_frame = Frame(input_frame, bg="#f0f0f0")
info_frame.pack()

# Create labels for alarm time display
alarm_label = Label(info_frame, text="Set your alarm", font=("Calibri", 18), bg="#f0f0f0")
alarm_label.pack(pady=(10, 0))

countdown_label = Label(info_frame, text="Countdown: --:--:--", font=("Calibri", 16), fg="#555", bg="#f0f0f0")
...
time_settings_frame = Frame(input_frame, bg="#f0f0f0")
time_settings_frame.pack(pady=5)

Label(time_settings_frame, text="Set Time", font=("Calibri", 16), bg="#f0f0f0").pack(pady=5)
...
footer_frame = Frame(root, bg="#f0f0f0")
